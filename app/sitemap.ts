...
const ROUTES: Entry[] = [
  ...
  { path: "/var-verkstad", changeFrequency: "yearly", priority: 0.5 },
  { path: "/kvalitet-miljo", changeFrequency: "yearly", priority: 0.5 },
  { path: "/karriar", changeFrequency: "monthly", priority: 0.5 },
